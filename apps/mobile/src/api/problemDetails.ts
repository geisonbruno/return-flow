...
/**
 * Turns any error this app might throw into a message safe to show a driver
 * — never a stack trace, exception class name, database detail, or raw
 * token. `fallback` is used whenever the error carries no safe, specific
